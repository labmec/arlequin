...
#ifndef TPZMIXEDDARCYFLOWARLEQUIN_H
#define TPZMIXEDDARCYFLOWARLEQUIN_H
...
class TPZMixedDarcyFlowArlequin : public TPZMatBase<STATE, TPZMatCombinedSpacesT<STATE>,
...
public:
	 ...
	 */
    [[maybe_unused]] TPZMixedDarcyFlowArlequin(int id, int dim);

    /**
             copy constructor
     */
    TPZMixedDarcyFlowArlequin(const TPZMixedDarcyFlowArlequin &copy);
    /**
             copy constructor
     */
    TPZMixedDarcyFlowArlequin &operator=(const TPZMixedDarcyFlowArlequin &copy);
    /**
	 * @brief Returns a 'std::string' with the name of the material
	 */
    [[nodiscard]] std::string Name() const override { return "TPZMixedDarcyFlowArlequin"; }
