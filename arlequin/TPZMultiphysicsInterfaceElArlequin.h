...
#ifndef TPZMULTIPHYSICSINTERFACEELHARLEQUIN
#define TPZMULTIPHYSICSINTERFACEELHARLEQUIN
 ...
 * @ingroup CompElement
 */
class TPZMultiphysicsInterfaceElementArlequin : public TPZMultiphysicsInterfaceElement {
...
// 	TPZMultiphysicsInterfaceElementArlequin();
	
// 	/** @brief Constructor */
	TPZMultiphysicsInterfaceElementArlequin(TPZCompMesh &mesh, TPZGeoEl *ref, TPZCompElSide left, TPZCompElSide right);
    
//     /** @brief Constructor */
//     TPZMultiphysicsInterfaceElementArlequin(TPZCompMesh &mesh, TPZGeoEl *ref);
    
//     /** @brief create a copy of the given element */
//     TPZMultiphysicsInterfaceElementArlequin(TPZCompMesh &mesh, const TPZMultiphysicsInterfaceElementArlequin &copy);
    
//     // /** @brief create a copy of the given element using index mapping */
//     // TPZMultiphysicsInterfaceElementArlequin(TPZCompMesh &mesh, const TPZMultiphysicsInterfaceElementArlequin &copy, std::map<int64_t,int64_t> & gl2lcConMap,
// 	// 								std::map<int64_t,int64_t> & gl2lcElMap);
	
// 	/** @brief Method for creating a copy of the element */
// 	virtual TPZCompEl *Clone(TPZCompMesh &mesh) const override 
//     {
//         return new TPZMultiphysicsInterfaceElementArlequin(mesh,*this);
//     }
// 	/**
...
//     // {
//     //     return new TPZMultiphysicsInterfaceElementArlequin(mesh,*this,gl2lcConMap,gl2lcElMap);
//     // }
...
// 	virtual ~TPZMultiphysicsInterfaceElementArlequin();
