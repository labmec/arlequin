...
TPZRegisterClassId(&TPZMultiphysicsInterfaceElementArlequin::ClassId),TPZCompEl(mesh, ref),fLeftElSide(0), fRightElSide(0)
{
...
TPZRegisterClassId(&TPZMultiphysicsInterfaceElementArlequin::ClassId),TPZCompEl(mesh, ref)
{
...
TPZRegisterClassId(&TPZMultiphysicsInterfaceElementArlequin::ClassId),TPZCompEl(mesh,copy)
{
...
TPZRegisterClassId(&TPZMultiphysicsInterfaceElementArlequin::ClassId),TPZCompEl(mesh,copy,gl2lcElMap)
{
